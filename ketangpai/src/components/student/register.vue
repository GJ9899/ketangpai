        ...
        <el-form label-width="80px" :model="form" :rules="rules" class="form" ref="form" >
          ...
          <el-form-item prop="name">
           ...
           <el-form-item prop="number">
            <el-input v-model.number="form.number" placeholder="学号"></el-input>
          </el-form-item>
          ...
          <el-form-item class="button">
            <el-button type="primary" @click="studentRegister('form')" style="width:353px">注册为学生</el-button>
          </el-form-item>
        </el-form>
      </div>
    ...
    studentRegister(formName){
      this.$refs[formName].validate((valid) => {
        if(valid){
          ...
          console.log(student);
          this.$axios.post('api/student/register',student)
          .then(res => {
